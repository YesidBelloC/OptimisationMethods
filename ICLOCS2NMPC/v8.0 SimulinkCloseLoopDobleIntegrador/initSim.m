...
global infoNLP data simtime solution tstep opt_step N opt_t_min Um1
Um1 = 0;
simtime=0; % initialize simulation time
tstep=0.01; % time step of simulation SI BAJO EL RESULT MEJORA !
...
N=5; % initial number of mesh points

options= settings_h(N);                        % Get options and solver settings
[problem,guess]=DoubleIntegratorNMPC;          % Fetch the problem definition
